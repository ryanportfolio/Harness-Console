...
- `launcher.mjs`: entry point (`Launch Harness Console.vbs` runs it). Serves the app on 43127, starts `usage/server.mjs` on 4545 (`USAGE_PORT` overrides), replaces a running instance unless it is mid-operation.
